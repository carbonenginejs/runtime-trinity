...
@type.define({ className: "Tr2DistanceTracker", family: "curves" })
export class Tr2DistanceTracker extends CjsModel {
  ...
  sourceObject: ITriVectorFunction | null = null;

  @io.notify
  @io.persist
  @type.objectRef("ITriVectorFunction")
  targetObject: ITriVectorFunction | null = null;
  ...
  @carbon.method
  @impl.adapted
  OnModified(_value?: unknown, time = 0): boolean {
