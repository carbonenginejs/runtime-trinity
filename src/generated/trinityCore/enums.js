...
export const PickComponent = Object.freeze({
  PICK_OBJECT: 1,
  PICK_AREA: 2,
  PICK_POSITION: 4,
  PICK_UV: 8,
...
export const CreationFlag = Object.freeze({
  CPU_WRITABLE: 1,
  GPU_WRITABLE: 2,
  DRAW_INDIRECT: 4,
});

export const BoundsMethod = Object.freeze({
  STATIC: 0,
  DYNAMIC: 1,
  DYNAMIC_SCALED: 2,
});

export const StaticCap = Object.freeze({
...
export const GetBatchesReason = Object.freeze({
  Draw: 0,
  Picking: 1,
});

export const ReflectionProbeRenderFrequency = Object.freeze({
...
export const ShadowSplitMode = Object.freeze({
  STATIC: 0,
  DYNAMIC: 1,
  MANUAL: 2,
});
...
export const RestartState = Object.freeze({
  NotRestarting: 0,
  WaitingToRestart: 1,
  WaitingForFrame: 2,
});

export const AtlasTextureType = Object.freeze({
  ATT_DEFAULT: 0,
  ATT_VIDEO: 1,
});
...
export const ApplicationActivation = Object.freeze({
  APP_ACTIVATED: 0,
  APP_DEACTIVATED: 1,
});

export const DeviceScreenType = Object.freeze({
  WINDOWED: 0,
  FULLSCREEN: 1,
  NO_ADAPTER: 2,
});
...
export const ThrottlingReason = Object.freeze({
