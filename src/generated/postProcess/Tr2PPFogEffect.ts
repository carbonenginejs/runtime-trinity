...
// Generated by format-carbon carbon-class --emit. Verify against postProcess/Tr2PPFogEffect.json.
...
export class Tr2PPFogEffect extends CjsModel
{
  ...
  @io.persist
  @type.vec3
  areaSize: Vec3 = vec3.fromValues(69142.0859375, 13828.4169922, 66337.203125);

  /** m_areaScale (Vector2) [READWRITE, PERSIST] */
  @io.persist
  @type.vec2
  areaScale: Vec2 = vec2.fromValues(30, 20);

  /** m_areaCenter (Vector3) [READWRITE, PERSIST] */
  @io.persist
  @type.vec3
  areaCenter: Vec3 = vec3.fromValues(-27042.2988281, -633.4446411, 11896.0957031);
  ...
  @io.persist
  @type.color
  color: Vec4 = vec4.fromValues(1, 0.4235294, 0, 1);
