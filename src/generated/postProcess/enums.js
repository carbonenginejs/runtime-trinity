...
export const BloomDebugMode = Object.freeze({
  BLOOM_DEBUG_NONE: 0,
  BLOOM_DEBUG_ALL: 1,
  BLOOM_DEBUG_STEP1: 2,
  BLOOM_DEBUG_STEP2: 3,
...
export const BlurChannel = Object.freeze({
  BC_r: 0,
  BC_g: 1,
  BC_b: 2,
  BC_a: 3,
...
export const BlurFinalize = Object.freeze({
  BF_None: 0,
  BF_MaxOfAllChannels: 1,
});

export const BlurProcess = Object.freeze({
  BP_None: 0,
  BP_Minimum: 1,
  BP_Maximum: 2,
});

export const BlurType = Object.freeze({
  BT_Big: 0,
  BT_Small: 1,
});
