...
// Generated by format-carbon carbon-class --emit. Verify against eve/ui/EveTacticalOverlay.json.
...
export class EveTacticalOverlay extends CjsModel
{
  ...
  @io.persist
  @type.vec4
  activeRange = vec4.fromValues(200000, 50000, 1, 50);

  /** m_ranges.y (Vector4) [READWRITE, PERSIST] */
  @io.persist
  @type.vec4
  rangeFadeLength = vec4.fromValues(200000, 50000, 1, 50);

  /** m_ranges.z (Vector4) [READWRITE, PERSIST] */
  @io.persist
  @type.vec4
  rangeMultiplier = vec4.fromValues(200000, 50000, 1, 50);

  /** m_ranges.w (Vector4) [READWRITE, PERSIST] */
  @io.persist
  @type.vec4
  sourceRadius = vec4.fromValues(200000, 50000, 1, 50);
