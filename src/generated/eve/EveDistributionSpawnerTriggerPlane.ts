...
// Generated by format-carbon carbon-class --emit. Verify against eve/EveDistributionSpawnerTriggerPlane.json.
import { io, type } from "@carbonenginejs/core-types/schema";
import { CjsModel } from "@carbonenginejs/core-types/model";
import { quat } from "@carbonenginejs/core-math/quat";
import type { Quat } from "@carbonenginejs/core-math/types";

/** EveDistributionSpawnerTriggerPlane (eve) - generated from schema shapeHash f7abe103.... */
@type.define({ className: "EveDistributionSpawnerTriggerPlane", family: "eve" })
export class EveDistributionSpawnerTriggerPlane extends CjsModel
{
  ...
  @io.persist
  @type.quat
  planeRotation: Quat = quat.create();
