...
// Generated by format-carbon carbon-class --emit. Verify against eve/EveSpriteSetItem.json.
...
/** EveSpriteSetItem (eve) - generated from schema shapeHash 6a187bdc.... */
@type.define({ className: "EveSpriteSetItem", family: "eve" })
export class EveSpriteSetItem extends CjsModel
{
  ...
  @io.persist
  @type.color
  warpColor: Vec4 = vec4.fromValues(1, 1, 1, 1);
