...
export class EveCamera extends CjsModel
{
  ...
  @io.readwrite
  @type.vec3
  extraTranslation: Vec3 = vec3.create();
  ...
  @io.persist
  @type.vec3
  intr: Vec3 = vec3.create();

  /** m_viewVec (Vector3) [READ] */
  @io.read
  @type.vec3
  viewVec: Vec3 = vec3.create();

  /** m_rightVec (Vector3) [READ] */
  @io.read
  @type.vec3
  rightVec: Vec3 = vec3.create();
  ...
  @io.persist
  @type.quat
  rotationAroundParent: Quat = quat.create();
  ...
  @io.persist
  @type.quat
  rotationOfInterest: Quat = quat.create();
  ...
  @io.persist
  @type.vec3
  translationFromParent: Vec3 = vec3.fromValues(0, 0, 20);
  ...
  @io.persist
  @type.vec3
  alignment: Vec3 = vec3.fromValues(0, 1, 0);
  ...
  @carbon.method
  @impl.notImplemented
  OrbitParent(...args: unknown[]): never
  {
  ...
  @carbon.method
  @impl.notImplemented
  RotateOnOrbit(...args: unknown[]): never
  {
  ...
  @carbon.method
  @impl.notImplemented
  ResetStartTime(...args: unknown[]): never
  {
  ...
  @carbon.method
  @impl.notImplemented
  SetRotationOnOrbit(...args: unknown[]): never
  {
