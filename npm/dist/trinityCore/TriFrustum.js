 ...
 * @returns {Number}
 */
function PlaneDotCoord(plane, point) {
 ...
 * @returns {Number}
 */
function PlaneDotNormal(plane, v) {
...
export { FLOAT_MAX, PlaneDotCoord, PlaneDotNormal, TriFrustum };
//# sourceMappingURL=TriFrustum.js.map
