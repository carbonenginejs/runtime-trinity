...
let _Tr2RenderContext;
new class extends _identity {
  static [class Tr2RenderContext extends CjsModel {
    static {
      [_Tr2RenderContext, _initClass] = _applyDecs2311(this, [type.define({
        className: "Tr2RenderContext",
        family: "trinityCore"
      })], [], 0, void 0, CjsModel).c;
    }
    ...
    ApplyStandardStates(renderingMode) {
      this.#intents.push({
        ...
        renderingMode: Number(renderingMode) >>> 0
      });
      return true;
    }
  ...
  TextureAddressMode = Object.freeze({
    TA_WRAP: 1,
    TA_MIRROR: 2,
    TA_CLAMP: 3,
    TA_BORDER: 4,
  ...
  #defaultContext = new _Tr2RenderContext();
  constructor() {
    super(_Tr2RenderContext), _initClass();
  }
}();

export { _Tr2RenderContext as Tr2RenderContext };
//# sourceMappingURL=Tr2RenderContext.js.map
