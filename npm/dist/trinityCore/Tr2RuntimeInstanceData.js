...
new class extends _identity {
  static [class Tr2RuntimeInstanceData extends CjsModel {
    ...
    OnModified(properties = null) {
      if (hasModifiedProperty(properties, "layout") || hasModifiedProperty(properties, "rows")) {
        this.#rebuildCpuData();
      }
      return true;
    }
