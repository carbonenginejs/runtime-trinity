...
class EveChildParticleSystem extends _EveChildTransform {
  static {
    ({
      ...
      family: "eve/child"
    })], [[[io, io.notify, io, io.persist, type, type.int32, void 0, schema.enum("ReflectionMode")], 16, "reflectionMode"], [[io, io.persist, void 0, type.list("ITr2GenericEmitter")], 16, "particleEmitters"], [[io, io.persist, void 0, type.list("Tr2ParticleSystem")], 16, "particleSystems"], [[io, io.persist, void 0, type.list("IEveChildTransformModifier")], 16, "transformModifiers"], [[io, io.notify, io, io.persist, type, type.boolean], 16, "display"], [[io, io.persist, type, type.string], 16, "name"], [[io, io.persist, void 0, type.objectRef("Tr2InstancedMesh")], 16, "mesh"], [[io, io.persist, type, type.uint32], 16, "lodClampLow"], [[io, io.persist, type, type.float32], 16, "lodSphereRadius"], [[io, io.persist, type, type.boolean], 16, "useDynamicLod"], [[io, io.persist, type, type.float32], 16, "lodFactorLow"], [[io, io.persist, type, type.float32], 16, "lodFactorMedium"], [[io, io.persist, type, type.float32], 16, "minScreenSize"], [[io, io.read, type, type.float32], 16, "currentScreenSize"]], 0, void 0, _EveChildTransform));
  }
  constructor(...args) {
    super(...args);
