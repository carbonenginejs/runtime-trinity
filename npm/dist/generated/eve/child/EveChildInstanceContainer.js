...
class EveChildInstanceContainer extends _EveChildTransform {
  static {
    ({
      ...
      family: "eve/child"
    })], [[[io, io.notify, io, io.persist, void 0, type.list("IEveChildTransformModifier")], 16, "transformModifiers"], [[io, io.persist, void 0, type.list("EveChildInstanceTransform")], 16, "transforms"], [[io, io.notify, io, io.persist, type, type.boolean], 16, "display"], [[io, io.persist, type, type.string], 16, "name"], [[io, io.persist, type, type.boolean], 16, "alwaysOn"], [[io, io.persist, void 0, type.objectRef("EveChildInheritProperties")], 16, "inheritProperties"], [[io, io.readwrite, type, type.boolean], 16, "reset"], [[io, io.read, void 0, type.list("IEveSpaceObjectChild")], 16, "instances"], [[io, io.notify, io, io.persist, type, type.string], 16, "locatorSet"], [[io, io.persistOnly, void 0, type.objectRef("IEveSpaceObjectChild")], 16, "source"], [[io, io.read, type, type.int32, void 0, schema.enum("Origin")], 16, "origin"], [[carbon, carbon.method, impl, impl.notImplemented], 18, "HandleControllerEvent"], [[carbon, carbon.method, impl, impl.notImplemented], 18, "SetControllerVariable"], [[carbon, carbon.method, impl, impl.notImplemented], 18, "StartControllers"]], 0, void 0, _EveChildTransform));
  }
  constructor(...args) {
    super(...args);
  ...
  HandleControllerEvent(...args) {
    throw _EveChildTransform.notImplemented("EveChildInstanceContainer", "HandleControllerEvent", args);
  }

  /** Carbon method SetControllerVariable (MAP_METHOD_AND_WRAP). */
  SetControllerVariable(...args) {
    throw _EveChildTransform.notImplemented("EveChildInstanceContainer", "SetControllerVariable", args);
  }

  /** Carbon method StartControllers (MAP_METHOD_AND_WRAP). */
  StartControllers(...args) {
    throw _EveChildTransform.notImplemented("EveChildInstanceContainer", "StartControllers", args);
  }
  static {
    _initClass();
  }
