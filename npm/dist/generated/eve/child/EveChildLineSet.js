...
class EveChildLineSet extends _EveChildTransform {
  static {
    ({
      ...
      family: "eve/child"
    })], [[[io, io.notify, io, io.persist, type, type.int32, void 0, schema.enum("lineSetType")], 16, "renderType"], [[io, io.persist, void 0, type.objectRef("EveCurveLineSet")], 16, "lineSet"], [[io, io.persist, type, type.string], 16, "name"], [[io, io.persist, type, type.boolean], 16, "display"], [[io, io.persist, type, type.float32], 16, "minScreenSize"], [[io, io.notify, io, io.persist, type, type.float32], 16, "brightness"], [[io, io.notify, io, io.persist, type, type.color], 16, "baseColor"], [[io, io.notify, io, io.persist, type, type.color], 16, "animColor"], [[io, io.notify, io, io.persist, type, type.boolean], 16, "additiveBatches"], [[io, io.notify, io, io.persist, type, type.float32], 16, "scrollSpeed"], [[io, io.persist, void 0, type.list("IEveLineSetPath")], 16, "lines"], [[io, io.persist, type, type.boolean], 16, "alwaysOn"], [[io, io.read, type, type.float32], 16, "currentScreenSize"], [[io, io.notify, io, io.persist, void 0, type.objectRef("Tr2Mesh")], 16, "mesh"], [[carbon, carbon.method, impl, impl.notImplemented], 18, "GetVertexElementAddedThroughCode"]], 0, void 0, _EveChildTransform));
  }
  constructor(...args) {
    super(...args);
  ...
  GetVertexElementAddedThroughCode(...args) {
    throw _EveChildTransform.notImplemented("EveChildLineSet", "GetVertexElementAddedThroughCode", args);
  }
  static {
    _initClass();
  }
