...
class EveChildEffectPropagator extends _EveChildContainer {
  static {
    ({
  ...
  Stop(...args) {
    throw _EveChildContainer.notImplemented("EveChildEffectPropagator", "Stop", args);
  }
  static {
    _initClass();
  }
