...
class Allign extends CjsModel {
  ...
  behaviorWeight = (_init_extra_behaviorPriority(this), _init_behaviorWeight(this, 1));

  /** m_visionRange (float) [READWRITE, PERSIST] */
  visionRange = (_init_extra_behaviorWeight(this), _init_visionRange(this, 75));

  /** m_enabled (bool) [READWRITE, PERSIST] */
  enabled = (_init_extra_visionRange(this), _init_enabled(this, true));

  /** m_framesBetweenUpdates (int32_t) [READWRITE, PERSIST] */
  framesBetweenUpdates = (_init_extra_enabled(this), _init_framesBetweenUpdates(this, 61));
...
export { _Allign as Allign };
//# sourceMappingURL=Allign.js.map
