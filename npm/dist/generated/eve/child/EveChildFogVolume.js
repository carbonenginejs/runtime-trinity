...
new class extends _identity {
  static [class EveChildFogVolume extends _EveChildTransform {
    ...
    [(_EnabledDecs = [io, io.persist, type, type.unknown], _intensityDecs = [io, io.persist, type, type.float32], _priorityDecs = [io, io.persist, type, type.int32, void 0, schema.enum("Priority")], _volumesDecs = [io, io.persist, void 0, type.list("IEveVolume")], _boundingSphereCenterDecs = [io, io.read, void 0, type.rawStruct("CcpMath::Sphere")], _boundingSphereRadiusDecs = [io, io.read, void 0, type.rawStruct("CcpMath::Sphere")], _nameDecs = [io, io.persist, type, type.string], _computedKeyDecs = [io, io.persist, type, type.unknown], "#NAME")] = (_init_extra_name(this), _init_computedKey(this, null));
