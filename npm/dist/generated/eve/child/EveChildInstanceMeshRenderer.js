...
class EveChildInstanceMeshRenderer extends _EveChildMesh {
  static {
    ({
      ...
      family: "eve/child"
    })], [[[io, io.persist, type, type.int32, void 0, schema.enum("RotationalConstraints")], 16, "rotationConstraint"], [[io, io.persist, type, type.quat], 16, "staticOffsetRotation"], [[io, io.persist, type, type.vec3], 16, "staticOffsetTranslation"], [[io, io.persist, void 0, type.objectRef("IEveDistributionMethod")], 16, "distribution"], [[io, io.persist, type, type.vec3], 16, "staticOffsetScale"], [[carbon, carbon.method, impl, impl.notImplemented], 18, "RefreshStaticGeometry"]], 0, void 0, _EveChildMesh));
  }
  constructor(...args) {
    super(...args);
  ...
  RefreshStaticGeometry(...args) {
    throw _EveChildMesh.notImplemented("EveChildInstanceMeshRenderer", "RefreshStaticGeometry", args);
  }
  static {
    _initClass();
  }
