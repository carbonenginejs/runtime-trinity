...
let _EveConnector;
class EveConnector extends CjsModel {
  static {
    ({
      ...
      family: "eve/ui"
    })], [[[io, io.persist, type, type.int32, void 0, schema.enum("ConnectorType")], 16, "type"], [[io, io.persist, type, type.color], 16, "color"], [[io, io.persist, type, type.float32], 16, "lineWidth"], [[io, io.persist, type, type.color], 16, "animationColor"], [[io, io.persist, type, type.float32], 16, "animationScale"], [[io, io.persist, type, type.float32], 16, "animationSpeed"], [[io, io.persist, type, type.boolean], 16, "isAnimated"], [[io, io.persist, type, type.boolean], 16, "autoScaleAnimation"], [[io, io.persist, type, type.vec3], 16, "destPosition"], [[io, io.persist, type, type.vec3], 16, "sourcePosition"], [[io, io.persist, void 0, type.objectRef("ITriVectorFunction")], 16, "destObject"], [[io, io.persist, void 0, type.objectRef("ITriVectorFunction")], 16, "sourceObject"], [[io, io.persist, type, type.vec3], 16, "planeNormal"], [[io, io.persist, type, type.float32], 16, "length"]], 0, void 0, CjsModel));
  }
  constructor(...args) {
    super(...args);
