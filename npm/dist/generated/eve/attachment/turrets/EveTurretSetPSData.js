...
class EveTurretSetPSData extends CjsModel {
  static {
    ...
    })], [[[type, type.vec4], 16, "shipData"], [[type, type.vec4], 16, "clipData1"], [[type, type.float32], 16, "clipRadius2Sq"], [[type, type.vec3], 16, "unused"], [[type, type.vec4], 16, "shLightingCoefficients"]], 0, void 0, CjsModel));
  }
  constructor(...args) {
    super(...args);
