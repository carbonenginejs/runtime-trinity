...
let _EveTurretSet;
class EveTurretSet extends _EveEntity {
  static {
    ({
  ...
  RebuildBoundingSphere(...args) {
    throw _EveEntity.notImplemented("EveTurretSet", "RebuildBoundingSphere", args);
  }

  /** Carbon method ForceStateDeactive (MAP_METHOD_AND_WRAP). */
  ForceStateDeactive(...args) {
    throw _EveEntity.notImplemented("EveTurretSet", "ForceStateDeactive", args);
  }

  /** Carbon method ForceStateTargeting (MAP_METHOD_AND_WRAP). */
  ForceStateTargeting(...args) {
    throw _EveEntity.notImplemented("EveTurretSet", "ForceStateTargeting", args);
  }

  /** Carbon method FreezeHighDetailLOD (MAP_METHOD_AND_WRAP). */
  FreezeHighDetailLOD(...args) {
    throw _EveEntity.notImplemented("EveTurretSet", "FreezeHighDetailLOD", args);
  }

  /** Carbon method GetShotTimeVariance (MAP_METHOD_AND_WRAP). */
  GetShotTimeVariance(...args) {
    throw _EveEntity.notImplemented("EveTurretSet", "GetShotTimeVariance", args);
  }

  /** Carbon method MissQueueSize (MAP_METHOD_AND_WRAP). */
  MissQueueSize(...args) {
    throw _EveEntity.notImplemented("EveTurretSet", "MissQueueSize", args);
  }

  /** Carbon method GetLastShotTime (MAP_METHOD_AND_WRAP). */
  GetLastShotTime(...args) {
    throw _EveEntity.notImplemented("EveTurretSet", "GetLastShotTime", args);
  }

  /** Carbon method EnterStateDeactive (MAP_METHOD_AND_WRAP). */
  EnterStateDeactive(...args) {
    throw _EveEntity.notImplemented("EveTurretSet", "EnterStateDeactive", args);
  }

  /** Carbon method EnterStateFiring (MAP_METHOD_AND_WRAP). */
  EnterStateFiring(...args) {
    throw _EveEntity.notImplemented("EveTurretSet", "EnterStateFiring", args);
  }

  /** Carbon method EnterStateIdle (MAP_METHOD_AND_WRAP). */
  EnterStateIdle(...args) {
    throw _EveEntity.notImplemented("EveTurretSet", "EnterStateIdle", args);
  }

  /** Carbon method EnterStateReloading (MAP_METHOD_AND_WRAP). */
  EnterStateReloading(...args) {
    throw _EveEntity.notImplemented("EveTurretSet", "EnterStateReloading", args);
  }

  /** Carbon method EnterStateTargeting (MAP_METHOD_AND_WRAP). */
  EnterStateTargeting(...args) {
    throw _EveEntity.notImplemented("EveTurretSet", "EnterStateTargeting", args);
  }

  /** Carbon method HandleControllerEvent (MAP_METHOD_AND_WRAP). */
  HandleControllerEvent(...args) {
    throw _EveEntity.notImplemented("EveTurretSet", "HandleControllerEvent", args);
  }

  /** Carbon method GetFiringBoneWorldTransform (MAP_METHOD_AND_WRAP). */
  GetFiringBoneWorldTransform(...args) {
    throw _EveEntity.notImplemented("EveTurretSet", "GetFiringBoneWorldTransform", args);
  }

  /** Carbon method SetControllerVariable (MAP_METHOD_AND_WRAP). */
  SetControllerVariable(...args) {
    throw _EveEntity.notImplemented("EveTurretSet", "SetControllerVariable", args);
  }

  /** Carbon method SetShotMissed (MAP_METHOD_AND_WRAP). */
  SetShotMissed(...args) {
    throw _EveEntity.notImplemented("EveTurretSet", "SetShotMissed", args);
  }

  /** Carbon method StartControllers (MAP_METHOD_AND_WRAP). */
  StartControllers(...args) {
    throw _EveEntity.notImplemented("EveTurretSet", "StartControllers", args);
  }
  static {
    _initClass();
  }
