...
class EveTurretSetVSData extends CjsModel {
  static {
    ...
    })], [[[type, type.vec4], 16, "baseCutoffData"], [[type, type.vec4], 16, "turretSetData"], [[type, type.mat4], 16, "shipMatrix"], [[type, type.mat4], 16, "prevShipMatrix"], [[type, type.uint32], 16, "currentBoneOffset"], [[type, type.uint32], 16, "prevBoneOffset"], [[type, type.uint32], 16, "_unused"], [[type, type.vec4], 16, "turretTranslation"], [[type, type.quat], 16, "turretRotation"]], 0, void 0, CjsModel));
  }
  constructor(...args) {
    super(...args);
  ...
  /** _unused (uint32_t) */
  _unused = (_init_extra_prevBoneOffset(this), _init__unused(this, 0));

  /** m_turretTranslation (Vector4) */
  turretTranslation = (_init_extra__unused(this), _init_turretTranslation(this, vec4.create()));

  /** m_turretRotation (Quaternion) */
  turretRotation = (_init_extra_turretTranslation(this), _init_turretRotation(this, quat.create()));
  static {
    _initClass();
  }
}
