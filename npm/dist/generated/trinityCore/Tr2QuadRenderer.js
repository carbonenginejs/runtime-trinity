...
class Tr2QuadRenderer extends CjsModel {
  static {
    ({
      ...
      family: "trinityCore"
    })], [[type.rawStruct("Tr2BufferAL"), 0, "quadIB"], [type.rawStruct("Tr2RingVertexBuffer"), 0, "vertexBuffer"], [[type, type.uint32], 16, "vertexBufferOffset"], [[type, type.uint32], 16, "lastInstanceDataSize"], [[type, type.uint32], 16, "bufferAlignment"], [type.rawStruct("CcpMallocBuffer"), 0, "buffer"], [[type, type.uint32], 16, "addedSize"], [type.objectRef("Tr2Material"), 0, "effect"], [[type, type.int32, void 0, schema.enum("TriBatchType")], 16, "batchType"], [[type, type.uint32], 16, "instanceSize"], [[type, type.uint32], 16, "vertexDeclHandle"], [[type, type.uint32], 16, "bufferOffset"], [[type, type.uint32], 16, "count"], [[type, type.uint32], 16, "quadCount"], [type.rawStruct("Tr2VertexDefinition"), 0, "definition"], [[type, type.unknown], 16, "combinable"], [[type, type.unknown], 16, "bufferSize"], [type.rawStruct("Tr2BufferAL"), 0, "quad"]], 0, void 0, CjsModel));
  }
  constructor(...args) {
    super(...args);
