...
let _Tr2Transform;
class Tr2Transform extends CjsModel {
  static {
    ({
      ...
      family: "trinityCore"
    })], [[[io, io.persist, type, type.int32, void 0, schema.enum("Tr2TransformModifier")], 16, "modifier"], [[io, io.read, type, type.mat4], 16, "localTransform"], [[io, io.read, type, type.mat4], 16, "worldTransform"], [[io, io.persist, type, type.string], 16, "name"], [[io, io.persist, type, type.vec3], 16, "scaling"], [[io, io.persist, type, type.quat], 16, "rotation"], [[io, io.persist, type, type.vec3], 16, "translation"], [[io, io.persist, type, type.float32], 16, "distanceBasedScaleArg1"], [[io, io.persist, type, type.float32], 16, "distanceBasedScaleArg2"], [[io, io.persist, void 0, type.objectRef("Tr2MeshBase")], 16, "mesh"], [[io, io.persist, void 0, type.list("TriCurveSet")], 16, "curveSets"], [[io, io.persist, type, type.boolean], 16, "useDistanceBasedScale"], [[io, io.persist, type, type.boolean], 16, "display"], [[io, io.persist, type, type.boolean], 16, "update"], [[io, io.persist, type, type.float32], 16, "sortValueMultiplier"]], 0, void 0, CjsModel));
  }
  constructor(...args) {
    super(...args);
