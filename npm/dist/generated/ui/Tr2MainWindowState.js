...
import { PresentInterval, Tr2WindowShowState, Tr2WindowMode } from '@carbonenginejs/runtime-const/render-context';
...
new class extends _identity {
  static [class Tr2MainWindowState extends CjsModel {
    static {
      ({
  ...
  Tr2WindowShowState = Tr2WindowShowState;
  Tr2WindowMode = Tr2WindowMode;
  constructor() {
    super(_Tr2MainWindowState), _initClass();
  }
}();
