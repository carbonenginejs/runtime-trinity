...
class Tr2TextureAnimationParameter extends CjsShaderParameter {
  static {
    ({
  ...
  RebuildEffectHandles(effectRes) {
    const resource = this.name ? CjsShaderParameter.getEffectResource(effectRes, this.name) : null;
    if (resource) {
