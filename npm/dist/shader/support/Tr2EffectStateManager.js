...
class Tr2EffectStateManager extends CjsModel {
  static {
    ({
  ...
  /** m_renderingMode (Tr2EffectStateManager::RenderingMode - enum Tr2EffectStateManager) */
