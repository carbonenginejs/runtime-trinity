  ...
  static [class Tr2PointLight extends _Tr2Light {
    static {
      ({
        ...
        family: "eve/lights"
      })], [[[io, io.persist, type, type.string], 16, "name"], [[io, io.persist, type, type.uint16], 16, "flags"], [[io, io.persist, type, type.vec3], 16, "position"], [[io, io.persist, type, type.quat], 16, "rotation"], [[io, io.notify, io, io.persist, type, type.int32], 16, "boneIndex"], [[io, io.persist, type, type.float32], 16, "radius"], [[io, io.persist, type, type.float32], 16, "innerRadius"], [[io, io.notify, io, io.persist, type, type.color], 16, "color"], [[io, io.notify, io, io.persist, type, type.float32], 16, "brightness"], [[io, io.persist, type, type.float32], 16, "noiseAmplitude"], [[io, io.persist, type, type.float32], 16, "noiseFrequency"], [[io, io.persist, type, type.uint32], 16, "noiseOctaves"], [[io, io.notify, io, io.persist, type, type.int32, void 0, schema.enum("PerLightShadowSetting")], 16, "castsShadows"], [[io, io.notify, io, io.persist, type, type.boolean], 16, "isVolumetric"], [[io, io.notify, io, io.persist, type, type.string], 16, "lightProfilePath"], [[io, io.read, void 0, type.objectRef("Tr2LightProfileRes")], 16, "lightProfile"]], 0, void 0, _Tr2Light));
    }
    ...
    constructor(...args) {
      super(...args);
      _Tr2Light.BindLightDataFields(this, _Tr2PointLight.LightDataFields);
    }
  }];
  LightDataFields = Object.freeze(["flags", "position", "rotation", "boneIndex", "radius", "innerRadius", "color", "brightness", "noiseAmplitude", "noiseFrequency", "noiseOctaves", "castsShadows", "isVolumetric"]);
  constructor() {
