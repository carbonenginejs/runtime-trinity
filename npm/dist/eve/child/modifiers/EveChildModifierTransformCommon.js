 ...
 */
function DistanceBase(context, transform, outAlignMat, outD) {
  const {
    camFwd,
    right,
    up
 ...
 * @returns {Float32Array} out
 */
function Billboard2D(context, transform, out) {
...
export { Billboard2D, DistanceBase };
//# sourceMappingURL=EveChildModifierTransformCommon.js.map
