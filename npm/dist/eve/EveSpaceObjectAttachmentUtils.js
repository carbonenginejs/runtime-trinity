 ...
 * FadeIn). */
function Blink(animationTime, blinkRate, blinkPhase, minScale, maxScale) {
  if (blinkRate === 0) {
    return minScale;
  }
...
function Fade(animationTime, type, blinkRate, blinkPhase) {
  switch (type) {
...
function Saturate(out, color, saturation) {
  if (saturation === 1) {
    out[0] = color[0];
    out[1] = color[1];
    out[2] = color[2];
...
export { Blink, Fade, FadeIn, FadeInOut, FadeOut, FadeType, Saturate };
//# sourceMappingURL=EveSpaceObjectAttachmentUtils.js.map
