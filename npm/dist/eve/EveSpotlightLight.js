...
class EveSpotlightLight extends CjsModel {
  static {
    ...
    })], [[type.rawStruct("LightData"), 0, "lightData"], [[type, type.mat4], 16, "boneMatrix"], [type.objectRef("Tr2LightProfileRes"), 0, "lightProfile"], [[type, type.boolean], 16, "boosterGainInfluence"], [[type, type.uint32], 16, "index"], [[type, type.string], 16, "lightProfilePath"]], 0, void 0, CjsModel));
  }
  constructor(...args) {
    super(...args);
