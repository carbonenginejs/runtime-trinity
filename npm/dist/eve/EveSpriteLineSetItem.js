...
new class extends _identity {
  static [class EveSpriteLineSetItem extends CjsModel {
    static {
      ...
      })], [[[io, io.persist, type, type.int32], 16, "boneIndex"], [[io, io.persist, type, type.string], 16, "name"], [[io, io.persist, type, type.boolean], 16, "isCircle"], [[io, io.persist, type, type.vec3], 16, "position"], [[io, io.persist, type, type.quat], 16, "rotation"], [[io, io.persist, type, type.vec3], 16, "scaling"], [[io, io.persist, type, type.float32], 16, "spacing"], [[io, io.persist, type, type.float32], 16, "blinkRate"], [[io, io.persist, type, type.float32], 16, "blinkPhase"], [[io, io.persist, type, type.float32], 16, "blinkPhaseShift"], [[io, io.persist, type, type.float32], 16, "minScale"], [[io, io.persist, type, type.float32], 16, "maxScale"], [[io, io.persist, type, type.float32], 16, "falloff"], [[io, io.persist, type, type.color], 16, "color"], [[carbon, carbon.method, impl, impl.adapted], 18, "GetBounds"], [[carbon, carbon.method, impl, impl.implemented], 18, "GetBoneIndex"], [[carbon, carbon.method, impl, impl.adapted], 18, "GetPositions"]], 0, void 0, CjsModel));
    }
    constructor(...args) {
      super(...args);
