...
new class extends _identity {
  static [class Tr2CurveVector3Lerp extends CjsModel {
    static {
      ({
  ...
  Tr2CurveVector3LerpKeyInterpolation = Tr2CurveVector3LerpKeyInterpolation;
  constructor() {
    super(_Tr2CurveVector3Lerp), _initClass();
  }
}();
