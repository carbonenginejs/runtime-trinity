import {
  CjsClearGrannyJsonResources,
  CjsClearPostUpdateCallbacks,
  CjsFlushPostUpdateCallbacks,
  CjsGetPostUpdateCallbackCount,
  CjsRegisterGrannyJsonResource,
  CjsRunNextPostUpdateCallback,
  type Color,
  type ITr2FollowCurveKey,
  type Quat,
  Tr2BoneMatrixCurve,
  ...
  Tr2CurveVector3Lerp,
  Tr2CurveVector3LerpKeyInterpolation,
  Tr2DistanceTracker,
  Tr2FollowCurve,
  Tr2FollowCurveKeyInterpolation,
  type Tr2FollowCurveKeyInterpolationValue,
  Tr2GrannyEventTrack,
  Tr2GrannyTrack,
  ...
  Tr2ObjectFollowCurveKeyRotationSetting,
...
type CurveConstructor = (new () => object) & { readonly name: string };
type ImplStatus = "adapted" | "implemented" | "noop";

Deno.test("curve methods expose source-backed Carbon metadata", () => {
  const constructors: CurveConstructor[] = [
    TriEventCurve,
    TriCurveSet,
    Tr2TranslationAdapter,
    Tr2RotationAdapter,
  ...
  assertEquals(CjsSchema.getClass("TriCurveSet"), TriCurveSet);
  assertEquals(CjsSchema.getClass("Tr2CurveScalar"), Tr2CurveScalar);

  const sourceBackedMethods: Array<[CurveConstructor, string, ImplStatus]> = [
    [TriEventCurve, "UpdateValue", "adapted"],
    [TriEventCurve, "Initialize", "implemented"],
    [TriEventCurve, "Length", "implemented"],
    [TriEventCurve, "Sort", "implemented"],
    [TriEventCurve, "AddKey", "implemented"],
    [TriEventCurve, "InsertKey", "implemented"],
    [TriEventCurve, "AddCallableKey", "adapted"],
    [TriEventCurve, "RemoveKey", "adapted"],
    [TriEventCurve, "GetKeyCount", "implemented"],
    [TriEventCurve, "GetKeyTime", "implemented"],
    [TriEventCurve, "GetKeyValue", "implemented"],
    [TriEventCurve, "SetKeyTime", "implemented"],
    [TriEventCurve, "SetKeyValue", "implemented"],
    [TriEventCurve, "GetCallableKeyValue", "adapted"],
    [TriEventCurve, "GetCallableKeyArgs", "adapted"],
    [TriCurveSet, "Update", "implemented"],
    [TriCurveSet, "OnSimClockRebase", "implemented"],
    [TriCurveSet, "Apply", "implemented"],
    [TriCurveSet, "ApplyTime", "implemented"],
    [TriCurveSet, "Initialize", "adapted"],
    [TriCurveSet, "Play", "implemented"],
    [TriCurveSet, "PlayTimeRange", "implemented"],
    [TriCurveSet, "PlayFrom", "adapted"],
    [TriCurveSet, "Stop", "implemented"],
    [TriCurveSet, "StopOnNextFrame", "implemented"],
    [TriCurveSet, "StopAfter", "implemented"],
    [TriCurveSet, "StopAfterWithCallback", "adapted"],
    [TriCurveSet, "GetTimeScale", "implemented"],
    [TriCurveSet, "GetScaledTime", "implemented"],
    [TriCurveSet, "SetName", "implemented"],
    [TriCurveSet, "GetName", "implemented"],
    [TriCurveSet, "GetCurvesCount", "implemented"],
    [TriCurveSet, "GetCurve", "implemented"],
    [TriCurveSet, "AddCurve", "implemented"],
    [TriCurveSet, "GetBindingsCount", "implemented"],
    [TriCurveSet, "GetBinding", "implemented"],
    [TriCurveSet, "AddBinding", "implemented"],
    [TriCurveSet, "GetMaxCurveDuration", "adapted"],
    [TriCurveSet, "GetRangeDuration", "implemented"],
    [TriCurveSet, "IsPlaying", "implemented"],
    [TriCurveSet, "UpdateWithCurrentTime", "adapted"],
    [TriCurveSet, "SetTimeRange", "implemented"],
    [TriCurveSet, "ResetTimeRange", "implemented"],
    [TriCurveSet, "HasTimeRange", "implemented"],
    [TriCurveSet, "GetTimeRange", "implemented"],
    [Tr2TranslationAdapter, "UpdateValue", "implemented"],
    [Tr2TranslationAdapter, "Update", "adapted"],
    [Tr2TranslationAdapter, "GetValueAt", "adapted"],
    [Tr2TranslationAdapter, "GetValueDotAt", "adapted"],
    [Tr2TranslationAdapter, "GetValueDoubleDotAt", "adapted"],
    [Tr2TranslationAdapter, "InterpolatedPosition", "adapted"],
    [Tr2TranslationAdapter, "RandomizeStart", "adapted"],
    [Tr2TranslationAdapter, "ScaleTime", "implemented"],
    [Tr2TranslationAdapter, "ResetStart", "implemented"],
    [Tr2RotationAdapter, "UpdateValue", "implemented"],
    [Tr2RotationAdapter, "Update", "adapted"],
    [Tr2RotationAdapter, "GetValueAt", "adapted"],
    [Tr2RotationAdapter, "GetValueDotAt", "adapted"],
    [Tr2RotationAdapter, "GetValueDoubleDotAt", "adapted"],
    [Tr2RotationAdapter, "RandomizeStart", "adapted"],
    [Tr2RotationAdapter, "ScaleTime", "implemented"],
    [Tr2RotationAdapter, "ResetStart", "implemented"],
    [Tr2ScalarFader, "Update", "adapted"],
    [Tr2ScalarFader, "StartFade", "implemented"],
    [Tr2ScalarFader, "IsZero", "implemented"],
    [Tr2ScalarFader, "GetFaderValue", "implemented"],
    [Tr2ScalarFader, "IsKickInZero", "implemented"],
    [Tr2ScalarFader, "GetKickInValue", "implemented"],
    [Tr2QuaternionLerpCurve, "UpdateValue", "implemented"],
    [Tr2QuaternionLerpCurve, "Update", "adapted"],
    [Tr2QuaternionLerpCurve, "GetValueAt", "adapted"],
    [Tr2QuaternionLerpCurve, "GetValueDotAt", "noop"],
    [Tr2QuaternionLerpCurve, "GetValueDoubleDotAt", "noop"],
    [Tr2QuaternionLerpCurve, "Length", "implemented"],
    [Tr2ObjectFollowCurveKey, "Initialize", "implemented"],
    [Tr2ObjectFollowCurveKey, "OnModified", "adapted"],
    [Tr2ObjectFollowCurveKey, "GetTime", "implemented"],
    [Tr2ObjectFollowCurveKey, "GetInterpolationType", "implemented"],
    [Tr2ObjectFollowCurveKey, "GetLeftTangent", "adapted"],
    [Tr2ObjectFollowCurveKey, "GetRightTangent", "adapted"],
    [Tr2ObjectFollowCurveKey, "GetValue", "adapted"],
    [Tr2FollowCurve, "UpdateValue", "implemented"],
    [Tr2FollowCurve, "Update", "adapted"],
    [Tr2FollowCurve, "GetValueAt", "adapted"],
    [Tr2FollowCurve, "GetValueDotAt", "noop"],
    [Tr2FollowCurve, "GetValueDoubleDotAt", "noop"],
    [Tr2FollowCurve, "InterpolatedPosition", "noop"],
    [Tr2FollowCurve, "GetValue", "adapted"],
    [Tr2FollowCurve, "OnListModified", "adapted"],
    [Tr2DistanceTracker, "UpdateValue", "implemented"],
    [Tr2DistanceTracker, "OnModified", "adapted"],
    [Tr2CurveVector3Lerp, "UpdateValue", "implemented"],
    [Tr2CurveVector3Lerp, "GetValue", "adapted"],
    [Tr2CurveVector3Lerp, "Update", "adapted"],
    [Tr2CurveVector3Lerp, "GetValueAt", "adapted"],
    [Tr2CurveVector3Lerp, "GetValueDotAt", "noop"],
    [Tr2CurveVector3Lerp, "GetValueDoubleDotAt", "noop"],
    [Tr2CurveVector3Lerp, "InterpolatedPosition", "noop"],
    [Tr2CurveVector3, "UpdateValue", "implemented"],
    [Tr2CurveVector3, "Length", "implemented"],
    [Tr2CurveVector3, "GetValue", "adapted"],
    [Tr2CurveVector3, "AddKey", "adapted"],
    [Tr2CurveVector3, "SetExtrapolation", "implemented"],
    [Tr2CurveVector3, "Update", "adapted"],
    [Tr2CurveVector3, "GetValueAt", "adapted"],
    [Tr2CurveVector3, "GetValueDotAt", "noop"],
    [Tr2CurveVector3, "GetValueDoubleDotAt", "noop"],
    [Tr2CurveVector3, "InterpolatedPosition", "noop"],
    [Tr2CurveVector2, "UpdateValue", "implemented"],
    [Tr2CurveVector2, "Length", "implemented"],
    [Tr2CurveVector2, "GetValue", "adapted"],
    [Tr2CurveVector2, "AddKey", "adapted"],
    [Tr2CurveVector2, "SetExtrapolation", "implemented"],
    [Tr2CurveVector2, "GetValueAt", "adapted"],
    [Tr2CurveScalar, "UpdateValue", "implemented"],
    [Tr2CurveScalar, "Update", "implemented"],
    [Tr2CurveScalar, "GetValueAt", "implemented"],
    [Tr2CurveScalar, "ScaleTime", "implemented"],
    [Tr2CurveScalar, "Length", "implemented"],
    [Tr2CurveScalar, "GetName", "implemented"],
    [Tr2CurveScalar, "SetName", "implemented"],
    [Tr2CurveScalar, "GetValue", "implemented"],
    [Tr2CurveScalar, "GetTangent", "implemented"],
    [Tr2CurveScalar, "GetTangentAt", "implemented"],
    [Tr2CurveScalar, "GetCurrentValue", "implemented"],
    [Tr2CurveScalar, "GetTimeOffset", "implemented"],
    [Tr2CurveScalar, "SetTimeOffset", "implemented"],
    [Tr2CurveScalar, "GetTimeScale", "implemented"],
    [Tr2CurveScalar, "SetTimeScale", "implemented"],
    [Tr2CurveScalar, "IsEmpty", "implemented"],
    [Tr2CurveScalar, "OnKeysChanged", "adapted"],
    [Tr2CurveScalar, "AddKey", "implemented"],
    [Tr2CurveScalar, "SetExtrapolation", "implemented"],
    [Tr2CurveScalar, "GetKeys", "implemented"],
    [Tr2CurveScalar, "SetDefinition", "adapted"],
    [Tr2CurveScalar, "GetDefinition", "adapted"],
    [Tr2CurveScalar, "Rasterize", "adapted"],
    [Tr2CurveRandomAxisRotation, "UpdateValue", "implemented"],
    [Tr2CurveRandomAxisRotation, "Update", "adapted"],
    [Tr2CurveRandomAxisRotation, "GetValueAt", "adapted"],
    [Tr2CurveRandomAxisRotation, "GetValueDotAt", "noop"],
    [Tr2CurveRandomAxisRotation, "GetValueDoubleDotAt", "noop"],
    [Tr2CurveRandomAxisRotation, "GetValue", "adapted"],
    [Tr2CurveRandomAxisRotation, "Initialize", "adapted"],
    [Tr2CurveRandomAxisRotation, "GetSeed", "implemented"],
    [Tr2CurveRandomAxisRotation, "SetSeed", "adapted"],
    [Tr2CurveRandomAxisRotation, "SeedChanged", "adapted"],
    [Tr2CurveQuaternion, "UpdateValue", "implemented"],
    [Tr2CurveQuaternion, "Update", "adapted"],
    [Tr2CurveQuaternion, "GetValueAt", "adapted"],
    [Tr2CurveQuaternion, "GetValueDotAt", "implemented"],
    [Tr2CurveQuaternion, "GetValueDoubleDotAt", "implemented"],
    [Tr2CurveQuaternion, "Length", "implemented"],
    [Tr2CurveQuaternion, "GetValue", "adapted"],
    [Tr2CurveQuaternion, "GetCurrentValue", "implemented"],
    [Tr2CurveQuaternion, "OnKeysChanged", "adapted"],
    [Tr2CurveQuaternion, "AddKey", "adapted"],
    [Tr2CurveQuaternion, "SetExtrapolation", "implemented"],
    [Tr2CurveEulerRotation, "UpdateValue", "implemented"],
    [Tr2CurveEulerRotation, "Update", "adapted"],
    [Tr2CurveEulerRotation, "GetValueAt", "adapted"],
    [Tr2CurveEulerRotation, "GetValueDotAt", "noop"],
    [Tr2CurveEulerRotation, "GetValueDoubleDotAt", "noop"],
    [Tr2CurveEulerRotation, "Length", "implemented"],
    [Tr2CurveEulerRotation, "GetValue", "adapted"],
    [Tr2CurveEulerRotation, "AddKey", "adapted"],
    [Tr2CurveEulerRotation, "SetExtrapolation", "implemented"],
    [Tr2CurveConstant, "UpdateValue", "noop"],
    [Tr2CurveConstant, "Update", "adapted"],
    [Tr2CurveConstant, "GetValueAt", "adapted"],
    [Tr2CurveConstant, "ScaleTime", "noop"],
    [Tr2CurveConstant, "GetValueDotAt", "implemented"],
    [Tr2CurveConstant, "GetValueDoubleDotAt", "implemented"],
    [Tr2CurveConstant, "InterpolatedPosition", "adapted"],
    [Tr2CurveCombiner, "UpdateValue", "implemented"],
    [Tr2CurveCombiner, "Length", "implemented"],
    [Tr2CurveCombiner, "GetValue", "adapted"],
    [Tr2CurveCombiner, "Update", "adapted"],
    [Tr2CurveCombiner, "GetValueAt", "adapted"],
    [Tr2CurveCombiner, "GetValueDotAt", "noop"],
    [Tr2CurveCombiner, "GetValueDoubleDotAt", "noop"],
    [Tr2CurveCombiner, "InterpolatedPosition", "noop"],
    [Tr2CurveColor, "UpdateValue", "adapted"],
    [Tr2CurveColor, "Update", "adapted"],
    [Tr2CurveColor, "GetValueAt", "adapted"],
    [Tr2CurveColor, "Length", "implemented"],
    [Tr2CurveColor, "GetValue", "adapted"],
    [Tr2CurveColor, "AddKey", "adapted"],
    [Tr2CurveColor, "SetExtrapolation", "implemented"],
    [Tr2CurveColorMixer, "UpdateValue", "implemented"],
    [Tr2CurveColorMixer, "Update", "adapted"],
    [Tr2CurveColorMixer, "GetValueAt", "adapted"],
    [Tr2CurveColorMixer, "Length", "implemented"],
    [Tr2CurveColorMixer, "GetValue", "adapted"],
  ];
  ...
  const jsOnlyMethods: Array<[CurveConstructor, string]> = [
    [TriEventCurve, "FireKey"],
    [TriCurveSet, "UpdateAt"],
    [TriCurveSet, "IsUsingSimTimeRebase"],
    [TriCurveSet, "ApplyTimeRange"],
    [TriCurveSet, "CallStopCallback"],
    [TriCurveSet, "DestroyStopCallback"],
    [Tr2TranslationAdapter, "GetLocalTime"],
    [Tr2TranslationAdapter, "GetStartAwareLocalTime"],
    [Tr2RotationAdapter, "GetLocalTime"],
    [Tr2RotationAdapter, "GetStartAwareLocalTime"],
    [Tr2ObjectFollowCurveKey, "GetLocator"],
    [Tr2ObjectFollowCurveKey, "GetRotation"],
    [Tr2ObjectFollowCurveKey, "GetWorldPosition"],
    [Tr2ObjectFollowCurveKey, "TransformByRotation"],
    [Tr2FollowCurve, "Sort"],
    [Tr2FollowCurve, "GetSegmentValue"],
    [Tr2FollowCurve, "GetHermiteSegmentValue"],
    [Tr2CurveVector3Lerp, "LerpToFirstKey"],
    [Tr2CurveScalar, "GetScaledTime"],
    [Tr2CurveScalar, "GetLocalTime"],
    [Tr2CurveScalar, "FindSegment"],
    [Tr2CurveScalar, "rasterize"],
    [Tr2CurveRandomAxisRotation, "Evaluate"],
    [Tr2CurveQuaternion, "GetName"],
    [Tr2CurveQuaternion, "SetName"],
    [Tr2CurveQuaternion, "GetLocalTime"],
    [Tr2CurveQuaternion, "FindSegment"],
    [Tr2CurveQuaternion, "Evaluate"],
    [Tr2CurveQuaternion, "GetSegmentValue"],
  ];
...
Deno.test("promoted curve families expose source-backed Carbon metadata", () => {
  const constructors: CurveConstructor[] = [
    Tr2BoneMatrixCurve,
    Tr2CameraFollowCurveKey,
    Tr2CurveEulerRotationExpression,
  ...
  const sourceBackedMethods: Array<[CurveConstructor, string, ImplStatus]> = [
    [Tr2BoneMatrixCurve, "Initialize", "adapted"],
    [Tr2BoneMatrixCurve, "Length", "implemented"],
    [Tr2BoneMatrixCurve, "UpdateValue", "adapted"],
    [Tr2BoneMatrixCurve, "GetValueAt", "adapted"],
    [Tr2BoneMatrixCurve, "GetValue", "adapted"],
    [Tr2BoneMatrixCurve, "Sort", "implemented"],
    [Tr2BoneMatrixCurve, "AddKey", "adapted"],
    [Tr2BoneMatrixCurve, "RemoveKey", "implemented"],
    [Tr2BoneMatrixCurve, "SetBone", "implemented"],
    [Tr2BoneMatrixCurve, "GetBone", "implemented"],
    [Tr2CameraFollowCurveKey, "Initialize", "adapted"],
    [Tr2CameraFollowCurveKey, "OnModified", "adapted"],
    [Tr2CameraFollowCurveKey, "CalculateBoxPosition", "adapted"],
    [Tr2CameraFollowCurveKey, "GetValue", "adapted"],
    [Tr2CameraFollowCurveKey, "GetTime", "implemented"],
    [Tr2CameraFollowCurveKey, "GetInterpolationType", "implemented"],
    [Tr2CameraFollowCurveKey, "GetLeftTangent", "adapted"],
    [Tr2CameraFollowCurveKey, "GetRightTangent", "adapted"],
    [Tr2CurveEulerRotationExpression, "Initialize", "adapted"],
    [Tr2CurveEulerRotationExpression, "UpdateValue", "implemented"],
    [Tr2CurveEulerRotationExpression, "Update", "adapted"],
    [Tr2CurveEulerRotationExpression, "GetValueAt", "adapted"],
    [Tr2CurveEulerRotationExpression, "GetValue", "adapted"],
    [Tr2CurveEulerRotationExpression, "GetValueDotAt", "noop"],
    [Tr2CurveEulerRotationExpression, "GetValueDoubleDotAt", "noop"],
    [Tr2CurveEulerRotationExpression, "GetExpressionYaw", "implemented"],
    [Tr2CurveEulerRotationExpression, "GetExpressionPitch", "implemented"],
    [Tr2CurveEulerRotationExpression, "GetExpressionRoll", "implemented"],
    [Tr2CurveEulerRotationExpression, "SetExpressionYaw", "adapted"],
    [Tr2CurveEulerRotationExpression, "SetExpressionPitch", "adapted"],
    [Tr2CurveEulerRotationExpression, "SetExpressionRoll", "adapted"],
    [Tr2CurveEulerRotationExpression, "GetInputValue", "implemented"],
    [Tr2CurveEulerRotationExpression, "GetRandomConstant", "implemented"],
    [Tr2CurveEulerRotationExpression, "ResetRandomConstant", "implemented"],
    [Tr2CurveEulerRotationExpression, "GetExpressionTermInfo", "adapted"],
    [Tr2CurveEulerRotationExpression, "EvaluateExpression", "adapted"],
    [Tr2CurveScalarExpression, "Initialize", "adapted"],
    [Tr2CurveScalarExpression, "UpdateValue", "implemented"],
    [Tr2CurveScalarExpression, "Update", "implemented"],
    [Tr2CurveScalarExpression, "GetValueAt", "implemented"],
    [Tr2CurveScalarExpression, "ScaleTime", "implemented"],
    [Tr2CurveScalarExpression, "GetValue", "adapted"],
    [Tr2CurveScalarExpression, "GetExpression", "implemented"],
    [Tr2CurveScalarExpression, "SetExpression", "adapted"],
    [Tr2CurveScalarExpression, "GetRandomConstant", "implemented"],
    [Tr2CurveScalarExpression, "GetInputValue", "implemented"],
    [Tr2CurveScalarExpression, "ResetRandomConstant", "implemented"],
    [Tr2CurveScalarExpression, "GetExpressionTermInfo", "adapted"],
    [Tr2CurveScalarExpression, "EvaluateExpression", "adapted"],
    [Tr2CurveVector3Expression, "Initialize", "adapted"],
    [Tr2CurveVector3Expression, "UpdateValue", "implemented"],
    [Tr2CurveVector3Expression, "Update", "adapted"],
    [Tr2CurveVector3Expression, "GetValueAt", "adapted"],
    [Tr2CurveVector3Expression, "GetValue", "adapted"],
    [Tr2CurveVector3Expression, "GetValueDotAt", "noop"],
    [Tr2CurveVector3Expression, "GetValueDoubleDotAt", "noop"],
    [Tr2CurveVector3Expression, "InterpolatedPosition", "noop"],
    [Tr2CurveVector3Expression, "GetExpressionX", "implemented"],
    [Tr2CurveVector3Expression, "GetExpressionY", "implemented"],
    [Tr2CurveVector3Expression, "GetExpressionZ", "implemented"],
    [Tr2CurveVector3Expression, "SetExpressionX", "adapted"],
    [Tr2CurveVector3Expression, "SetExpressionY", "adapted"],
    [Tr2CurveVector3Expression, "SetExpressionZ", "adapted"],
    [Tr2CurveVector3Expression, "GetInputValue", "implemented"],
    [Tr2CurveVector3Expression, "GetRandomConstant", "implemented"],
    [Tr2CurveVector3Expression, "ResetRandomConstant", "implemented"],
    [Tr2CurveVector3Expression, "GetExpressionTermInfo", "adapted"],
    [Tr2CurveVector3Expression, "EvaluateExpression", "adapted"],
    [Tr2GrannyEventTrack, "TracksReady", "implemented"],
    [Tr2GrannyEventTrack, "ResetTracks", "implemented"],
    [Tr2GrannyEventTrack, "ApplyTracks", "adapted"],
    [Tr2GrannyEventTrack, "UpdateValueImpl", "adapted"],
    [Tr2GrannyTrack, "Initialize", "adapted"],
    [Tr2GrannyTrack, "OnModified", "adapted"],
    [Tr2GrannyTrack, "SetGrannyResource", "adapted"],
    [Tr2GrannyTrack, "UpdateValue", "adapted"],
    [Tr2GrannyTrack, "Length", "implemented"],
    [Tr2GrannyTrack, "SetCurves", "adapted"],
    [Tr2GrannyTrack, "UpdateValueImpl", "noop"],
    [Tr2GrannyTrack, "ResetTracks", "noop"],
    [Tr2GrannyTrack, "ApplyTracks", "noop"],
    [Tr2GrannyTrack, "TracksReady", "noop"],
    [Tr2GrannyTransformTrack, "TracksReady", "implemented"],
    [Tr2GrannyTransformTrack, "ResetTracks", "implemented"],
    [Tr2GrannyTransformTrack, "ApplyTracks", "adapted"],
    [Tr2GrannyTransformTrack, "UpdateValueImpl", "adapted"],
    [Tr2GrannyVectorTrack, "TracksReady", "implemented"],
    [Tr2GrannyVectorTrack, "ResetTracks", "implemented"],
    [Tr2GrannyVectorTrack, "ApplyTracks", "adapted"],
    [Tr2GrannyVectorTrack, "UpdateValueImpl", "adapted"],
    [Tr2ScalarExprKey, "Initialize", "adapted"],
    [Tr2ScalarExprKey, "OnModified", "adapted"],
    [Tr2ScalarExprKey, "RegenRandomConstant", "implemented"],
    [Tr2ScalarExprKey, "UpdateValues", "adapted"],
    [Tr2ScalarExprKeyCurve, "Initialize", "adapted"],
    [Tr2ScalarExprKeyCurve, "Length", "implemented"],
    [Tr2ScalarExprKeyCurve, "UpdateValue", "implemented"],
    [Tr2ScalarExprKeyCurve, "GetValueAt", "adapted"],
    [Tr2ScalarExprKeyCurve, "GetKeyTime", "implemented"],
    [Tr2ScalarExprKeyCurve, "SetKeyTime", "implemented"],
    [Tr2ScalarExprKeyCurve, "GetKeyValue", "implemented"],
    [Tr2ScalarExprKeyCurve, "SetKeyValue", "implemented"],
    [Tr2ScalarExprKeyCurve, "GetKeyCount", "implemented"],
    [Tr2ScalarExprKeyCurve, "GetKeyInterpolation", "implemented"],
    [Tr2ScalarExprKeyCurve, "SetKeyInterpolation", "implemented"],
    [Tr2ScalarExprKeyCurve, "GetKeyLeftTangent", "implemented"],
    [Tr2ScalarExprKeyCurve, "SetKeyLeftTangent", "implemented"],
    [Tr2ScalarExprKeyCurve, "GetKeyRightTangent", "implemented"],
    [Tr2ScalarExprKeyCurve, "SetKeyRightTangent", "implemented"],
    [Tr2ScalarExprKeyCurve, "AddKey", "adapted"],
    [Tr2ScalarExprKeyCurve, "RemoveKey", "implemented"],
    [Tr2ScalarExprKeyCurve, "Sort", "adapted"],
  ];
  ...
  const jsOnlyMethods: Array<[CurveConstructor, string]> = [
    [Tr2CurveEulerRotationExpression, "Compile"],
    [Tr2CurveEulerRotationExpression, "GetContext"],
    [Tr2CurveScalarExpression, "Compile"],
    [Tr2CurveVector3Expression, "Compile"],
    [Tr2ScalarExprKeyCurve, "Update"],
    [Tr2ScalarExprKeyCurve, "GetKeyTangent"],
    [Tr2ScalarExprKeyCurve, "SetKeyTangent"],
    [Tr2ScalarExprKeyCurve, "GetLocalTime"],
  ];
...
Deno.test("Granny JSON tracks bind the first matching group and sample values", () => {
  const source = {
    animations: [{
      duration: 4,
      timeStep: 1,
      trackGroups: [{
        ...
        transformTracks: [{
          name: "Bone",
          position: { format: 4, degree: 0, controls: [1, 2, 3] },
          orientation: { format: 5, degree: 0, controls: [0, 0, 0, 1] },
          scaleShear: {
            format: 3,
            degree: 0,
            controls: [
        ...
        textTracks: [{
          name: "Events",
          entries: [
            { timeStamp: 0.5, text: "warmup" },
            { timeStamp: 1.5, text: "fire" },
            { timeStamp: 3.5, text: "cooldown" },
          ],
        }],
      }],
    }],
  ...
  CjsClearGrannyJsonResources();
  CjsRegisterGrannyJsonResource("res:/synthetic/test.gr2", source);
  ...
  assertEquals(
    CjsSchema.getField(Tr2GrannyTrack, "grannyResPath")?.type.kind,
    "path",
  );
  CjsClearGrannyJsonResources();
  ...
  eventTrack.eventListener = {
    HandleEvent: (value: string) => events.push(value),
  };
    ...
    animations: [
      {
        duration: 1,
        timeStep: 1,
        trackGroups: [{ name: "root", transformTracks: [] }],
      },
      source.animations[0],
    ],
  };
...
Deno.test("Granny JSON tracks tolerate raw wrappers and reject missing curves", () => {
  const rawWrapped = {
    fileInfo: {
      Animations: [{
        Duration: 0,
        ...
        TrackGroups: [{
          ...
          TextTracks: [{
            Name: "Events",
            Entries: [{ TimeStamp: 0, Text: "ready" }],
          }],
        }],
      }],
    },
...
function assertCarbonMethod(
  ...
  assertEquals(
    method?.impl?.status,
    status,
    `${ctor.name}.${methodName} should have impl status ${status}`,
  );
}

Deno.test("expression curves expose Carbon term metadata and current-time inputs", () => {
  const scalar = new Tr2CurveScalarExpression();
  scalar.inputs = [{
    Update: (time: number) => time + 1,
    GetValueAt: (time: number) => time + 1,
  }];
  scalar.ScaleTime(2);
  ...
  assertEquals(
    CjsSchema.getField(Tr2CurveScalarExpression, "expression")?.io
      ?.persistOnly,
    true,
  );
  assertEquals(
    CjsSchema.getField(Tr2CurveScalarExpression, "input1")?.io?.persist,
    true,
  );

  const vector = new Tr2CurveVector3Expression();
  vector.inputs = [{
    Update: (time: number) => time * 2,
    GetValueAt: (time: number) => time * 2,
  }];
  vector.timeScale = 3;
  ...
  const colorOut: Color = vec4.createLinear();
  ...
  const derivative: Vec3 = vec3.fromValues(7, 8, 9);
  ...
  const eulerOut: Quat = quat.create();
...
Deno.test("Tr2ScalarExprKeyCurve applies Carbon time scale and offset", () => {
  assertEquals(
    new Tr2ScalarExprKey().interpolation,
    Tr2CurveInterpolation.LINEAR,
  );
  assertEquals(
    new Tr2ScalarExprKeyCurve().interpolation,
    Tr2CurveInterpolation.LINEAR,
  );
...
Deno.test("Tr2ScalarExprKeyCurve follows Carbon Hermite interpolation", () => {
  const curve = new Tr2ScalarExprKeyCurve();
...
Deno.test("Tr2ScalarExprKey evaluates Carbon key variable buffers", () => {
...
Deno.test("promoted follow and bone curves keep Carbon defaults", () => {
  ...
  boneCurve.skinnedObject = {
    GetBoneTransform(name: string): Mat4 | null {
  ...
  assertAlmostEquals((rollover.endValue as Mat4)[12], 5);
  const rolloverKeys = rollover.keys as Tr2MatrixKey[];
  assertEquals((rolloverKeys[0].time as number), 1);
  assertAlmostEquals((rolloverKeys[0].value as Mat4)[12], 0);
});
...
Deno.test("Tr2CurveQuaternion evaluates constant, slerp, and cycle wrapping", () => {
  ...
  const valueOut: Quat = quat.create();
  ...
  assertEquals(
    CjsSchema.getField(Tr2CurveQuaternion, "keys")?.type.kind,
    "array",
  );
  assertEquals(
...
Deno.test("Tr2CurveVector2 composes scalar component curves", () => {
  ...
  assertEquals(
    CjsSchema.getField(Tr2CurveVector2, "x")?.type.kind,
    "objectRef",
  );
  assertEquals(
...
Deno.test("Tr2CurveVector3 composes scalar component curves", () => {
  ...
  assertEquals(
    CjsSchema.getField(Tr2CurveVector3, "x")?.type.kind,
    "objectRef",
  );
  assertEquals(
...
Deno.test("Tr2CurveColor composes scalar component curves and gamma output", () => {
  ...
  curve.AddKey(
    0,
    vec4.fromValues(0.25, 0.5, 0.75, 1),
    Tr2CurveInterpolation.LINEAR,
  );
  curve.AddKey(
    2,
    vec4.fromValues(0.5, 1, 0.25, 0.5),
    Tr2CurveInterpolation.LINEAR,
  );

  const value: Color = vec4.create();
  curve.GetValue(1, value);
  ...
  const noAlphaValue: Color = vec4.create();
  ...
  const negativeOut: Color = vec4.createLinear();
  ...
  assertEquals(
    CjsSchema.getField(Tr2CurveColor, "currentValue")?.type.kind,
    "color",
  );
});
...
Deno.test("Tr2CurveEulerRotation composes scalar curves with Carbon rotation order", () => {
  ...
  assertEquals(
    CjsSchema.getField(Tr2CurveEulerRotation, "yaw")?.type.kind,
    "objectRef",
  );
  assertEquals(
...
Deno.test("Tr2CurveRandomAxisRotation spins between source random rotations", () => {
  ...
  const seededValueA: Quat = quat.create();
  const seededValueB: Quat = quat.create();
  ...
  assertEquals(
    CjsSchema.getField(Tr2CurveRandomAxisRotation, "currentValue")?.type.kind,
    "quat",
  );
});
...
Deno.test("Tr2CurveConstant serves scalar, vector, quaternion, and color functions", () => {
  ...
  assertEquals(
    CjsSchema.getField(Tr2CurveConstant, "value")?.type.kind,
    "vec4",
  );
  assertEquals(
...
Deno.test("Tr2QuaternionLerpCurve blends child quaternion functions", () => {
  ...
  assertEquals(
    CjsSchema.getField(Tr2QuaternionLerpCurve, "start")?.type.kind,
    "float64",
  );
  assertEquals(
    CjsSchema.getField(Tr2QuaternionLerpCurve, "startCurve")?.type.kind,
    "objectRef",
  );
});

Deno.test("Tr2CurveVector3Lerp blends into a child vector function", () => {
  ...
  assertEquals(
    CjsSchema.getField(Tr2CurveVector3Lerp, "curve")?.type.kind,
    "objectRef",
  );
  assertEquals(
    CjsSchema.getField(Tr2CurveVector3Lerp, "startInterpolation")?.type.kind,
    "uint32",
  );
});

Deno.test("Tr2FollowCurve samples constant, linear, and hermite key segments", () => {
  const curve = new Tr2FollowCurve();
  curve.keys = [
    makeFollowKey(2, vec3.fromValues(4, 2, 0)),
    makeFollowKey(0, vec3.fromValues(0, 0, 0)),
  ];
  curve.Sort();
  ...
  curve.keys[0] = makeFollowKey(
    0,
    vec3.fromValues(10, 0, 0),
    Tr2FollowCurveKeyInterpolation.CONSTANT,
  );
  curve.GetValueAt(1, out);
...
Deno.test("Tr2ObjectFollowCurveKey follows object and locator rotation", () => {
  ...
  assertEquals(
    key.GetInterpolationType(),
    Tr2FollowCurveKeyInterpolation.LINEAR,
  );

  const z90 = quat.setAxisAngle(
    quat.create(),
  ...
  key.object = {
    ...
    worldRotation: z90,
    locatorSets: [{ name: "mount", locators: [locator] }],
  };
  ...
  assertEquals(
    CjsSchema.getField(Tr2ObjectFollowCurveKey, "object")?.type.kind,
    "objectRef",
  );
  assertEquals(
    CjsSchema.getField(Tr2ObjectFollowCurveKey, "rotationSetting")?.type.kind,
    "int32",
  );
});

Deno.test("Tr2RotationAdapter forwards curves and falls back to value", () => {
  ...
  assertEquals(
    CjsSchema.getField(Tr2RotationAdapter, "curve")?.type.kind,
    "objectRef",
  );
  assertEquals(
    CjsSchema.getField(Tr2RotationAdapter, "currentValue")?.type.kind,
    "quat",
  );
});

Deno.test("Tr2TranslationAdapter forwards curves, rotates updates, and derives", () => {
  const adapter = new Tr2TranslationAdapter();
  vec3.copy(adapter.value, vec3.fromValues(1, 0, 0));
  quat.setAxisAngle(
    adapter.rotationOffset,
    vec3.fromValues(0, 0, 1),
    Math.PI / 2,
  );
  ...
  assertAlmostEquals(out[0], 0);
  assertEquals(
    CjsSchema.getField(Tr2TranslationAdapter, "rotationOffset")?.type.kind,
    "quat",
  );
  assertEquals(
    CjsSchema.getField(Tr2TranslationAdapter, "currentValue")?.type.kind,
    "vec3",
  );
});

Deno.test("Tr2DistanceTracker measures projected and signed distances", () => {
  ...
  assertEquals(
    CjsSchema.getField(Tr2DistanceTracker, "sourceObject")?.type.kind,
    "objectRef",
  );
  assertEquals(
    CjsSchema.getField(Tr2DistanceTracker, "value")?.type.kind,
    "float32",
  );
});
...
Deno.test("Tr2CurveColorMixer blends, saturates, brightens, and converts color", () => {
  ...
  assertEquals(
    CjsSchema.getField(Tr2CurveColorMixer, "color1")?.type.kind,
    "color",
  );
  assertEquals(
...
Deno.test("TriEventCurve sorts keys, fires forward events, and cycles", () => {
  ...
  const callableArgs: unknown[] = [];
  const callableCurve = new TriEventCurve();
  callableCurve.AddCallableKey(1, (...args: unknown[]) => {
    callableArgs.push(...args);
  }, ["a", "b"]);
  CjsClearPostUpdateCallbacks();
  callableCurve.UpdateValue(1);
  assertEquals(callableArgs.join(","), "");
  assertEquals(CjsGetPostUpdateCallbackCount(), 1);
  assertEquals(CjsRunNextPostUpdateCallback(), true);
  assertEquals(callableArgs.join(","), "a,b");
  assertEquals(CjsRunNextPostUpdateCallback(), false);
  assertEquals(CjsFlushPostUpdateCallbacks(), 0);

  const cycling = new TriEventCurve();
  const cycleEvents: string[] = [];
  cycling.eventListener = {
    HandleEvent: (value: string) => cycleEvents.push(value),
  };
...
Deno.test("TriCurveSet plays, ranges, applies curves, and copies bindings", () => {
  ...
  driven.driver = { GetCurveSetTime: (time: number) => time * 2 };
  driven.PlayFrom(0);
  driven.Update(3);
...
function makeVectorCurve(value: Vec3, length: number) {
  return {
    ...
    Update(_time: number, out: Vec3) {
      return vec3.copy(out, value);
    },
    GetValueAt(_time: number, out: Vec3) {
      return vec3.copy(out, value);
    },
    GetValueDotAt(_time: number, out: Vec3) {
      return out;
    },
    GetValueDoubleDotAt(_time: number, out: Vec3) {
      return out;
    },
  };
}
...
function IsIdentityMat4(value: Mat4): boolean {
  for (let i = 0; i < 16; i++) {
